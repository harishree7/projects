/*******************************************************************************
* File Name: RadioController_IntClock.c
* Version 1.60
*
*  Description:
...
/*******************************************************************************
* Function Name: RadioController_IntClock_Start
********************************************************************************
* Summary:
...
void RadioController_IntClock_Start(void) 
{
    ...
    RadioController_IntClock_CLKEN |= RadioController_IntClock_CLKEN_MASK;
}


/*******************************************************************************
* Function Name: RadioController_IntClock_Stop
********************************************************************************
* Summary:
...
void RadioController_IntClock_Stop(void) 
{
	...
	CYDEV_CHIP_REVISION_USED == CYDEV_CHIP_REVISION_5A_ES1))
/*******************************************************************************
* Function Name: RadioController_IntClock_StopBlock
********************************************************************************
* Summary:
...
{
    if (RadioController_IntClock_CLKEN & RadioController_IntClock_CLKEN_MASK)
    {
...
#else
        CLK_DIST_DMASK = RadioController_IntClock_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(RadioController_IntClock_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(RadioController_IntClock_DIV_PTR, oldDivider);
#endif
    }
}
#endif
...
/*******************************************************************************
* Function Name: RadioController_IntClock_StandbyPower
********************************************************************************
* Summary:
...
void RadioController_IntClock_StandbyPower(uint8 state) 
{
    if(state == 0)
    {
        RadioController_IntClock_CLKSTBY &= ~RadioController_IntClock_CLKSTBY_MASK;
    }
    else
    {
        RadioController_IntClock_CLKSTBY |= RadioController_IntClock_CLKSTBY_MASK;
...
/*******************************************************************************
* Function Name: RadioController_IntClock_SetDividerRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void RadioController_IntClock_SetDividerRegister(uint16 clkDivider, uint8 restart) 
{
    uint8 enabled;

    uint8 currSrc = RadioController_IntClock_GetSourceRegister();
    uint16 oldDivider = RadioController_IntClock_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = RadioController_IntClock_CLKEN & RadioController_IntClock_CLKEN_MASK;
        ...
        if (currSrc == CYCLK_SRC_SEL_CLK_SYNC_D && (oldDivider == 0 || clkDivider == 0))
        {
            ...
            if (oldDivider == 0 && clkDivider != 0)
            {
                ...
                CY_SET_REG16(RadioController_IntClock_DIV_PTR, clkDivider);
                RadioController_IntClock_MOD_SRC &= ~CYCLK_SSS;
            }
            else
            {
        ...
        else
        {
            ...
            RadioController_IntClock_CLKEN |= enabled;
        }
    }
}
...
/*******************************************************************************
* Function Name: RadioController_IntClock_GetDividerRegister
********************************************************************************
* Summary:
...
{
    return CY_GET_REG16(RadioController_IntClock_DIV_PTR);
}


/*******************************************************************************
* Function Name: RadioController_IntClock_SetModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void RadioController_IntClock_SetModeRegister(uint8 clkMode) 
{
    RadioController_IntClock_MOD_SRC |= clkMode & RadioController_IntClock_MODE_MASK;
}


/*******************************************************************************
* Function Name: RadioController_IntClock_ClearModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void RadioController_IntClock_ClearModeRegister(uint8 clkMode) 
{
    RadioController_IntClock_MOD_SRC &= ~clkMode | ~RadioController_IntClock_MODE_MASK;
}
...
/*******************************************************************************
* Function Name: RadioController_IntClock_GetModeRegister
********************************************************************************
* Summary:
...
{
    return RadioController_IntClock_MOD_SRC & RadioController_IntClock_MODE_MASK;
}


/*******************************************************************************
* Function Name: RadioController_IntClock_SetSourceRegister
********************************************************************************
* Summary:
...
{
    uint16 currDiv = RadioController_IntClock_GetDividerRegister();
    uint8 oldSrc = RadioController_IntClock_GetSourceRegister();
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        RadioController_IntClock_MOD_SRC |= CYCLK_SSS;
        RadioController_IntClock_MOD_SRC =
            (RadioController_IntClock_MOD_SRC & ~RadioController_IntClock_SRC_SEL_MSK) | clkSource;
    }
...
/*******************************************************************************
* Function Name: RadioController_IntClock_GetSourceRegister
********************************************************************************
* Summary:
...
{
    return RadioController_IntClock_MOD_SRC & RadioController_IntClock_SRC_SEL_MSK;
}
