...
/* Vin */
#define Vin__0__INTTYPE CYREG_PICU2_INTTYPE0
#define Vin__0__MASK 0x01u
#define Vin__0__PC CYREG_PRT2_PC0
#define Vin__0__PORT 2u
#define Vin__0__SHIFT 0
#define Vin__AG CYREG_PRT2_AG
#define Vin__AMUX CYREG_PRT2_AMUX
#define Vin__BIE CYREG_PRT2_BIE
#define Vin__BIT_MASK CYREG_PRT2_BIT_MASK
#define Vin__BYP CYREG_PRT2_BYP
#define Vin__CTL CYREG_PRT2_CTL
#define Vin__DM0 CYREG_PRT2_DM0
#define Vin__DM1 CYREG_PRT2_DM1
#define Vin__DM2 CYREG_PRT2_DM2
#define Vin__DR CYREG_PRT2_DR
#define Vin__INP_DIS CYREG_PRT2_INP_DIS
#define Vin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Vin__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Vin__LCD_EN CYREG_PRT2_LCD_EN
#define Vin__MASK 0x01u
#define Vin__PORT 2u
#define Vin__PRT CYREG_PRT2_PRT
#define Vin__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Vin__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Vin__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Vin__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Vin__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Vin__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Vin__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Vin__PS CYREG_PRT2_PS
#define Vin__SHIFT 0
#define Vin__SLW CYREG_PRT2_SLW
