...
#define BS_IOPINS1_2_VAL ((const uint8 CYFAR *)0x48000120u)

/* IOPINS1_3 Address: CYREG_PRT3_DM0 + 0x00000009u Size (bytes): 5 */
#define BS_IOPINS1_3_VAL ((const uint8 CYFAR *)0x48000128u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0), 0x0367u);
...
const struct CY_DMA_TD_PROTO_ENTRY CYCODE LCD_Seg_1_Com__DMA_TD_PROTO_BLOCK[1] =
{
    {2, 1},
};

const struct CY_DMA_TD_PROTO_ENTRY CYCODE LCD_Seg_1_Seg__DMA_TD_PROTO_BLOCK[1] =
{
    {3, 1},
};
