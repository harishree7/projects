...
{
    if (SPIM_1_IntClock_CLKEN & SPIM_1_IntClock_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void SPIM_1_IntClock_SetModeRegister(uint8 clkMode) 
{
    SPIM_1_IntClock_MOD_SRC |= clkMode & SPIM_1_IntClock_MODE_MASK;
}
...
*
*******************************************************************************/
void SPIM_1_IntClock_ClearModeRegister(uint8 clkMode) 
{
    SPIM_1_IntClock_MOD_SRC &= ~clkMode | ~SPIM_1_IntClock_MODE_MASK;
}
...
{
    return SPIM_1_IntClock_MOD_SRC & SPIM_1_IntClock_MODE_MASK;
}
...
void SPIM_1_IntClock_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        SPIM_1_IntClock_MOD_SRC =
            (SPIM_1_IntClock_MOD_SRC & ~SPIM_1_IntClock_SRC_SEL_MSK) | clkSource;
    }
