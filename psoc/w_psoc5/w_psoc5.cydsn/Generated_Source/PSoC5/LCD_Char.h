...
#define LCD_Char_VERTICAL_BG              (1u)    /* Horizontal Bar Graph */
#define LCD_Char_HORIZONTAL_BG            (2u)    /* Vertical Bar Graph   */
...
typedef struct _LCD_Char_backupStruct
{
    uint8 enableState;
...
void LCD_Char_Wakeup(void);
...
#if((LCD_Char_CUSTOM_CHAR_SET == LCD_Char_VERTICAL_BG) || (LCD_Char_CUSTOM_CHAR_SET == LCD_Char_HORIZONTAL_BG))
    ...
    #define LCD_Char_PrintNumber(x)       LCD_Char_PrintDecUint16(x)
    #define LCD_Char_PrintInt8(x)         LCD_Char_PrintHexUint8(x)
    #define LCD_Char_PrintInt16(x)        LCD_Char_PrintHexUint16(x)
...
#define LCD_Char_PORT_SHIFT               LCD_Char_LCDPort__SHIFT
#define LCD_Char_PORT_MASK                LCD_Char_LCDPort__MASK
...
/* Pin Masks */
#define LCD_Char_RS                       (0x20u << LCD_Char_LCDPort__SHIFT)
#define LCD_Char_RW                       (0x40u << LCD_Char_LCDPort__SHIFT)
#define LCD_Char_E                        (0x10u << LCD_Char_LCDPort__SHIFT)
#define LCD_Char_READY_BIT                (0x08u << LCD_Char_LCDPort__SHIFT)
#define LCD_Char_DATA_MASK                (0x0Fu << LCD_Char_LCDPort__SHIFT)
