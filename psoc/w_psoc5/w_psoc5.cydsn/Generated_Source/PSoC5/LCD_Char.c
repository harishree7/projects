...
char8 const CYCODE LCD_Char_hex[16u] = "0123456789ABCDEF";
...
*
*******************************************************************************/
void LCD_Char_IsReady() 
{    
    uint8 value = 0u;    

    /* Clear the LCD port*/
    LCD_Char_PORT_DR_REG &= ~LCD_Char_PORT_MASK ;

    /* Change Port to High-Z Status on data pins */
    
    /* Mask off data pins to clear old values out */
    value = LCD_Char_PORT_DM0_REG & ~LCD_Char_DATA_MASK;
    /* Load in high Z values for data pins, others unchanged */
    LCD_Char_PORT_DM0_REG = value | (LCD_Char_HIGH_Z_DM0 & LCD_Char_DATA_MASK);

    /* Mask off data pins to clear old values out */
    value = LCD_Char_PORT_DM1_REG & ~LCD_Char_DATA_MASK;
    /* Load in high Z values for data pins, others unchanged */
    LCD_Char_PORT_DM1_REG = value | (LCD_Char_HIGH_Z_DM1 & LCD_Char_DATA_MASK);

    /* Mask off data pins to clear old values out */
    value = LCD_Char_PORT_DM2_REG & ~LCD_Char_DATA_MASK;
    /* Load in high Z values for data pins, others unchanged */
    LCD_Char_PORT_DM2_REG = value | (LCD_Char_HIGH_Z_DM2 & LCD_Char_DATA_MASK);
    ...
    value = LCD_Char_PORT_DM0_REG & (~LCD_Char_DATA_MASK);
    /* Load in high Z values for data pins, others unchanged */
    LCD_Char_PORT_DM0_REG = value | (LCD_Char_STRONG_DM0 & LCD_Char_DATA_MASK);
...
*
*******************************************************************************/
void LCD_Char_WrDatNib(uint8 nibble) 
{
    LCD_Char_IsReady();
    ...
    /* Clear data pins */
    LCD_Char_PORT_DR_REG &= ~LCD_Char_DATA_MASK;	        
    
    /* Write in data, bring E high*/
    LCD_Char_PORT_DR_REG |= (LCD_Char_E | (nibble << LCD_Char_PORT_SHIFT));
...
{	    
    ...
    /*******************************************************************************
    *  Function Name: LCD_Char_PrintHexUint8
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void LCD_Char_PrintHexUint8(uint8 value) 
    {
    ...
    /*******************************************************************************
    *  Function Name: LCD_Char_PrintHexUint16
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void LCD_Char_PrintHexUint16(uint16 value) 
    {
        LCD_Char_PrintHexUint8(value >> LCD_Char_U16_UPPER_BYTE_SHIFT);
        LCD_Char_PrintHexUint8(value & LCD_Char_U16_LOWER_BYTE_MASK);
    }
    
    
    /*******************************************************************************
    *  Function Name: LCD_Char_PrintDecUint16
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void LCD_Char_PrintDecUint16(uint16 value) 
    {
        ...
        {
            temp[index] = (value % LCD_Char_TEN) + '0';
            value /= LCD_Char_TEN;
            index++;
        }
