...
/* Stores internal component configuration for unconfigured mode */
    ...
    /* Common config vars */
    volatile uint8 UART_scbMode = UART_SCB_MODE_UNCONFIG;
    volatile uint8 UART_scbEnableWake;

    /* I2C config vars */
    volatile uint8 UART_mode;
    volatile uint8 UART_acceptAddr;

    /* SPI/UART config vars */
    volatile uint8 * UART_rxBuffer;
    volatile uint8   UART_rxDataBits;
    volatile uint32  UART_rxBufferSize;

    volatile uint8 * UART_txBuffer;
    volatile uint8   UART_txDataBits;
    volatile uint32  UART_txBufferSize;
