...
extern UART_BACKUP_STRUCT UART_backup;
    ...
    /* Common config vars */
    extern volatile uint8 UART_scbMode;
    extern volatile uint8 UART_scbEnableWake;

    /* I2C config vars */
    extern volatile uint8 UART_mode;
    extern volatile uint8 UART_acceptAddr;

    /* SPI/UART config vars */
    extern volatile uint8 * UART_rxBuffer;
    extern volatile uint8   UART_rxDataBits;
    extern volatile uint32  UART_rxBufferSize;

    extern volatile uint8 * UART_txBuffer;
    extern volatile uint8   UART_txDataBits;
    extern volatile uint32  UART_txBufferSize;
